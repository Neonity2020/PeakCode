...
export const MULTI_AGENT_PROTOCOL = [
  ...
  "   写进结论，不要让报告看起来是全绿的。",
  "   注意：每个 worker 有**时间预算**，跑过头会被停下并把它的半成品交回给你（卡片上写",
  '   "ran past its ...-minute budget"）。拿到半成品不要当成完整结论：把它按「做到了哪一步、',
  "   还差什么」写进报告。同理，子任务本身要写小 —— 派一个「分析整个前端性能」这种没有边界的活，",
  "   worker 只会在仓库里一直翻到预算用完；把它切成「先定位渲染热点」这类能收敛的问题。",
