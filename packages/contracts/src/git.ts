...
// Pi text generation model used by git helpers (commit message / PR / branch / title / diff summary).
export const DEFAULT_GIT_TEXT_GENERATION_MODEL = "pi-coding-agent" as const;
