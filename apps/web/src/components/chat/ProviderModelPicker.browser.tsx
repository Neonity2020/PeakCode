...
async function mountPicker(props: {
  ...
  const screen = await render(
    <ProviderModelPicker
      ...
      {...(props.loadingModels ? { loadingModels: props.loadingModels } : {})}
...
describe("ProviderModelPicker", () => {
  ...
  it("shows Pi models directly when opened", async () => {
  ...
  it("shows search when the provider has at least fifteen models", async () => {
    const mounted = await mountPicker({
      provider: "pi",
  ...
  it("shows a loading skeleton when models are still loading", async () => {
    const mounted = await mountPicker({
      provider: "pi",
      model: "openai/gpt-5",
      loadingModels: true,
