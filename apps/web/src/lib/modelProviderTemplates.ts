...
export const MODEL_PROVIDER_TEMPLATES: readonly ModelProviderTemplate[] = [
  ...
  },
  {
    ...
    note: "小米 MiMo 开放平台，同时兼容 OpenAI 与 Anthropic 协议；模型 ID 以控制台为准，可在此编辑。",
    models: [
      { id: "mimo-v2-5-pro", name: "MiMo V2.5 Pro", reasoning: true, ...text },
      { id: "mimo-v2-5", name: "MiMo V2.5", reasoning: true, ...text },
    ],
  },
