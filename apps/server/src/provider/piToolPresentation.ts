/**
 * PiToolPresentation - Presentation mapping for Pi tool calls into provider item titles and lifecycle data.
 *
 * @module PiToolPresentation
 */
import type { ImageContent, TextContent } from "@earendil-works/pi-ai";

import type { PiTrackedToolCall } from "./piSessionSnapshot.ts";
